...
messages = [
    ...
    "DELETE /api/events/123 204 7.104 ms - -",
]
...
print("===== OPTIONAL RUNTIME VALUE CLUSTERING =====")
...
assert len(real_clusters) == 1, (
    "A missing runtime value must not split an otherwise "
    "structurally compatible family."
)
...
print()
print(
    "OPTIONAL RUNTIME VALUE CLUSTERING TEST PASSED"
)
