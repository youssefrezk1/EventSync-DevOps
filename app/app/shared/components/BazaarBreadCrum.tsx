...
interface BazaarBreadcrumbProps {
  bazaarId: string | number;
}

export default function BazaarBreadcrumb({ bazaarId }: BazaarBreadcrumbProps) {
  ...
  const breadcrumbItems = [
    ...
    {
      label: "Bazaars",
      icon: <Store sx={{ fontSize: "1.1rem" }} />,
      path: `/dashboards/${dashboardRole}/events?type=bazaars`,
    },
  ];
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
        ...
        >
          ...
          {/* Current Page - Bazaar ID */}
          <Chip
            icon={<Store sx={{ fontSize: "1rem" }} />}
            label={`Bazaar #${bazaarId}`}
            size="small"
            sx={{
              height: 32,
              fontWeight: 600,
