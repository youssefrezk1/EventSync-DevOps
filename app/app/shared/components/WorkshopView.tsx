...
import { SearchFilters, useEvents, } from "../services";
...
const fetchProfessors = async () => {
  try {
    ...
    // Backend returns an array of professor names (strings)
                    ...
                    >
                      <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        <FavoriteButton
                          ...
                          eventType="workshop"
                          isFavorited={isFavorited(workshop._id)}
                ...
                {selectedWorkshop?.ProfCreator && (
                  <Box display="flex" alignItems="top">
                    ...
                    <Box display="flex" gap={1}>
                      ...
                      <Typography variant="body2" fontWeight={500}>
                        Prof. {selectedWorkshop.ProfCreator.firstName}{" "}
                        {selectedWorkshop.ProfCreator.lastName}
                      </Typography>
                    </Box>
                  </Box>
                )}
