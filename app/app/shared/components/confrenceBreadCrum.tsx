...
interface ConferenceBreadcrumbProps {
  conferenceId: string | number;
}

export default function ConferenceBreadcrumb({ conferenceId }: ConferenceBreadcrumbProps) {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      path: `/dashboards/${dashboardRole}/events?type=conferences`,
    },
  ];
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
        ...
        >
          ...
          {/* Current Page - Conference ID */}
          <Chip
            icon={<Business sx={{ fontSize: "1rem" }} />}
            label={`Conference #${conferenceId}`}
            size="small"
            sx={{
              height: 32,
              fontWeight: 600,
