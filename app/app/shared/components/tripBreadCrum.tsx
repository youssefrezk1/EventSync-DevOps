...
export default function TripBreadcrumb({ tripId }: TripBreadcrumbProps) {
  ...
  const breadcrumbItems = [
    ...
    {
      label: "Trips",
      icon: <Flight sx={{ fontSize: "1.1rem" }} />,
      path: `/dashboards/${dashboardRole}/events?type=trips`,
    },
  ];
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
        ...
        >
          ...
          {/* Current Page - Trip ID */}
          <Chip
            icon={<Flight sx={{ fontSize: "1rem" }} />}
            label={`Trip #${tripId}`}
            size="small"
            sx={{
              height: 32,
