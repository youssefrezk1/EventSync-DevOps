...
import { useEvents, type Event, type SearchFilters } from "../../../shared/services";
...
function EventPageContent() {
  ...
  // Fetch events based on selected type
  ...
  return (
    <BasicLayout menuItems={menuItems}>
      {/* Hero Section - Same as student version */}
      <Box
        sx={{
          position: "relative",
          borderRadius: 4,
      ...
      {/* Tabs Section - Same as student version */}
      <Box
        sx={{
      ...
      {/* Filters Sidebar and Content - Same as student version */}
