...
import { EventAvailable, LocalOffer, School } from "@mui/icons-material";
...
const faqs = [
  {
    question: "How do I organize a workshop?",
    answer:
      "Navigate to the Workshops section, click 'Create Workshop', and follow the setup guide to define your workshop details, schedule, and participants.",
  },
  {
  ...
  {
    question: "Can I access the gym facilities?",
    answer:
      "Yes, professors have access to gym facilities. Check the Gym section for available hours and facilities. Your faculty ID grants you full access.",
  },
  {
    question: "How do I participate in campus events?",
    answer:
      "Browse available events in the Events section, and register for those you'd like to attend. You can manage your registrations from 'Registered events'.",
  },
];
  ...
  const statistics = [
    {
      ...
      icon: <WorkIcon sx={{ fontSize: 28, color: theme.palette.primary.main }} />,
      color: theme.palette.primary.main,
    },
    {
      value: "500+",
      label: "Total Students Taught",
      icon: <School sx={{ fontSize: 28, color: theme.palette.success.main }} />,
      color: theme.palette.success.main,
    },
    {
      value: "100+",
      label: "Monthly Events",
      icon: <EventIcon sx={{ fontSize: 28, color: theme.palette.secondary.dark }} />,
      ...
      <Box sx={{ width: "100%", overflow: "hidden" }}>
        ...
        >
          ...
          >
            ...
            >
              Inspire, educate, and connect with students through engaging workshops and campus events
            </Typography>
            <Box
              sx={{
                display: "flex",
            ...
            <CardContent sx={{ p: 4 }}>
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 3, flexWrap: "wrap" }}>
                ...
                <Box sx={{ flex: 1, minWidth: 300 }}>
                  ...
                  >
                    Access exclusive discounts from participating vendors across campus and enjoy special offers tailored for faculty.
                  </Typography>
                  ...
                  <Button
                    variant="contained"
                    endIcon={<EastIcon />}
                    href="/dashboards/professor/loyaltyProgram"
                    sx={{
                      borderRadius: 2,
