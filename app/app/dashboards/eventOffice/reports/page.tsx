...
import FileDownloadIcon from "@mui/icons-material/FileDownload";import BasicLayout from "@/components/layouts/basicLayout2";
  ...
  const revenueColumns: TableColumn<ReportEvent>[] = [
{
   ...
   label: (
    <Box 
            // New Outer Box: Sets width to 100% and contains the border.
            sx={{ 
                display: "flex", 
                alignItems: "center", 
                ...
                cursor: "pointer",
                borderRight: '1px solid #e2e8f0' // Border at the 100% edge
            }} 
            onClick={() => handleRevenueSort("eventName")}
        >
            {/* Original Inner Box: Maintains the 90% width for content (text and arrows) */}
            <Box sx={{ 
                display: "flex", 
                alignItems: "center", 
                justifyContent: "space-between", 
                width: "90%", // Content is indented
            }}>
   ...
   render: (row: ReportEvent) => <TextCell text={row.eventName || "N/A"} fontWeight={600} />,
      ...
      label: (
        <Box 
    // 1. Outer Box: Set width to 100% to fill the column space 
    // and place the border at the true edge of the column.
    sx={{ 
        display: "flex", 
        alignItems: "center", 
        justifyContent: "space-between", 
        ...
        cursor: "pointer",
        borderRight: '1px solid #e2e8f0' // Border now applies to the full column width
    }} 
    onClick={() => handleRevenueSort("eventType")}
>
    {/* 2. Inner Box: Contains the text and arrows. 
        Setting its width to 90% ensures the arrows are indented. */}
    <Box sx={{ 
        display: "flex", 
        alignItems: "center", 
        justifyContent: "space-between", 
        width: "90%", // <-- This box contains the elements and keeps them to 90%
    }}>
        <Typography sx={{ fontSize: "0.75rem", fontWeight: 600, color: "#6b7280" }}>
            EVENT TYPE
        </Typography>
      ...
      },    },
{
   ...
   render: (row: ReportEvent) => <DateRangeCell start={row.start} end={row.end} />,
      ...
      label: (
        ...
        width: "90%", cursor: "pointer" }} onClick={() => handleRevenueSort("revenue")}>
          <Typography sx={{ fontSize: "0.75rem", fontWeight: 600, color: "#6b7280" }}>
            REVENUE
          </Typography>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 0.25 }}>
  ...
  const attendeesColumns: TableColumn<ReportEvent>[] = [
    {
        ...
        label: (
            <Box
                // New Outer Box: Full width (100%) and contains the border and click handler
                sx={{
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "flex-start", // Keep content to the start
                    width: "100%",
                    cursor: "pointer",
            ...
            >
                {/* Inner Box: Sets content width to 90% and uses space-between */}
                <Box sx={{ 
                    display: "flex", 
                    alignItems: "center", 
                    justifyContent: "space-between", // Pushes arrows to the 90% edge
                    width: "90%", 
                }}>
                    <Typography sx={{ fontSize: "0.75rem", fontWeight: 600, color: "#6b7280" }}>
                        EVENT NAME
        ...
        label: (
            <Box
                ...
                sx={{
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center", // Align the whole 90% block to the center
                    width: "100%",
                    cursor: "pointer",
                    borderRight: '1px solid #e2e8f0'
                }}
